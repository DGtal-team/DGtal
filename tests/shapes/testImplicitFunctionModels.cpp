...
bool testImplicitFunctionModels()
{
  ...
  DGTAL_CONCEPT_CHECK(requires concepts::CImplicitFunction< _ImplicitBall2D > );
  DGTAL_CONCEPT_CHECK(requires concepts::CImplicitFunction< _ImplicitBall3D > );
  DGTAL_CONCEPT_CHECK(requires concepts::CImplicitFunction< _ImplicitNorm1Ball2D > );
  DGTAL_CONCEPT_CHECK(requires concepts::CImplicitFunction< _ImplicitNorm1Ball3D > );
  DGTAL_CONCEPT_CHECK(requires concepts::CImplicitFunction< _ImplicitHyperCube2D > );
  DGTAL_CONCEPT_CHECK(requires concepts::CImplicitFunction< _ImplicitHyperCube3D > );
