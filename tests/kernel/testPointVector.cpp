  ...
  SECTION("Other operators with integers")
    {
      ...
      REQUIRE( p1.cosineSimilarity(p1) == Approx(0.).epsilon(0.00001));
      REQUIRE( p1.cosineSimilarity(-p1) == Approx(pi).epsilon(0.00001));
      REQUIRE( p1.cosineSimilarity( Point(-2,1,-4,3) ) == Approx(pi/2).epsilon(0.000001) );
      REQUIRE( cosineSimilarity(p1, p1) == Approx(0.).epsilon(0.00001) );
      REQUIRE( cosineSimilarity(p1, -p1) == Approx(pi).epsilon(0.00001) );
      REQUIRE( cosineSimilarity(p1, Point(-2,1,-4,3)) == Approx(pi/2).epsilon(0.00001) );
  ...
  SECTION("Other operators with reals")
    {
      ...
      REQUIRE( p3.cosineSimilarity(p3) == Approx(0.).epsilon(0.0001) );
      REQUIRE( p3.cosineSimilarity(-p3) == Approx(pi).epsilon(0.0001) );
      REQUIRE( p3.cosineSimilarity( RealPoint(1.0,1.0,2.0,2.0) ) == Approx(pi/2).epsilon(0.0001) );
      REQUIRE( cosineSimilarity(p3, p3) == Approx(0.).epsilon(0.0001) );
      REQUIRE( cosineSimilarity(p3, -p3) == Approx(pi).epsilon(0.0001) );
      REQUIRE( cosineSimilarity(p3, RealPoint(1.0,1.0,2.0,2.0)) == Approx(pi/2).epsilon(0.0001) );
  ...
  SECTION("Other operators with mixed integers/reals")
    {
      ...
      REQUIRE( p1.cosineSimilarity(RealPoint(p1)) == Approx(0.).epsilon(0.0001) );
      REQUIRE( p1.cosineSimilarity(-RealPoint(p1)) == Approx(pi).epsilon(0.0001) );
      REQUIRE( p1.cosineSimilarity( RealPoint(-2,1,-4,3) ) == Approx(pi/2).epsilon(0.0001) );
      REQUIRE( cosineSimilarity(p1, RealPoint(p1)) == Approx(0.).epsilon(0.0001) );
      REQUIRE( cosineSimilarity(p1, -RealPoint(p1)) == Approx(pi).epsilon(0.0001) );
      REQUIRE( cosineSimilarity(p1, RealPoint(-2,1,-4,3)) == Approx(pi/2).epsilon(0.0001) );

      REQUIRE( p3.cosineSimilarity(Point(1,-1,2,-2)) == Approx(0.).epsilon(0.0001) );
      REQUIRE( p3.cosineSimilarity(-Point(1,-1,2,-2)) == Approx(pi).epsilon(0.0001) );
      REQUIRE( p3.cosineSimilarity( Point(1,1,2,2) ) == Approx(pi/2).epsilon(0.0001) );
      REQUIRE( cosineSimilarity(p3, Point(1,-1,2,-2)) == Approx(0.).epsilon(0.0001) );
      REQUIRE( cosineSimilarity(p3, -Point(1,-1,2,-2)) == Approx(pi).epsilon(0.0001) );
      REQUIRE( cosineSimilarity(p3, Point(1,1,2,2)) == Approx(pi/2).epsilon(0.0001) );
