...
bool testLocalEstimatorFromFunctorAdapter()
{
  ...
  typedef DGtal::functors::ConstValueFunctor< double > ConvFunctor;
  typedef LocalEstimatorFromSurfelFunctorAdapter<SurfaceContainer, Z3i::L2Metric, 
                                                 Functor, ConvFunctor> Reporter;

  typedef LocalEstimatorFromSurfelFunctorAdapter<SurfaceContainer, Z3i::L2Metric, 
                                                 Functor, DGtal::functors::GaussianKernelFunctor> ReporterGaussian;
  ...
  DGtal::functors::GaussianKernelFunctor gaussKernelFunc(1.0);
