...
/**
 * @file testRobustHoughAccumulatorNormalVectorEstimator.cpp
 * @ingroup Tests
 ...
 * @date 2016/03/14
 *
 * Functions for testing class RobustHoughAccumulatorNormalVectorEstimator.
 *
...
#include "DGtal/geometry/surfaces/estimation/estimationFunctors/RobustHoughAccumulatorNormalVectorEstimator.h"
...
TEST_CASE( "Testing RobustHoughAccumulatorNormalVectorEstimator" )
{
  ...
  typedef RobustHoughAccumulatorNormalVectorEstimator<Surfel, CanonicSCellEmbedder<KSpace> > SphericalHough;
