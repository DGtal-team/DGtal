...
bool testDistanceTransformation()
{
  ...
  drawImage<Gray>(board, image, (unsigned int)0, (unsigned int)255); //image.selfDraw<Gray> ( board, 0, 255 );
  ...
  board.clear();
  drawImage<Gray>(board, result, (DGtal::int64_t)0, (DGtal::int64_t)16); //result.selfDraw<Gray> ( board, 0, 16 );
...
bool testDistanceTransformationNeg()
{
  ...
  Board2D board;
  board.setUnit ( LibBoard::Board::UCentimeter );
  drawImage<Gray>(board, image, (unsigned int)0, (unsigned int)1); //image.selfDraw<Gray> ( board, 0, 1 );
  ...
  board.clear();
  drawImage<Gray>(board, result, (DGtal::int64_t)0, (DGtal::int64_t)maxv); //result.selfDraw<Gray> ( board, 0, maxv );
...
bool testDTFromSet()
{
  ...
  drawImage<Hue>(board, result, (DGtal::int64_t)0, (DGtal::int64_t)maxv+1); //result.selfDraw<Hue> ( board, 0, maxv+1);
  ...
  for ( ImageLong::Iterator it = result0.begin(), itend = result0.end();
    ...
    if ( (*it) > maxv)
      maxv = (*it);
  trace.error() << "MaxV="<<maxv<<std::endl;
  drawImage<Hue>(board, result0, (DGtal::int64_t)0, (DGtal::int64_t)maxv+1); //result0.selfDraw<Hue> ( board, 0, maxv+1);
  ...
  for ( ImageLong::Iterator it = result1.begin(), itend = result1.end();
    ...
    if ( (*it) > maxv)
      maxv = (*it);
  trace.error() << "MaxV="<<maxv<<std::endl;
  drawImage<Hue>(board, result1, (DGtal::int64_t)0, (DGtal::int64_t)maxv+1); //result1.selfDraw<Hue> ( board, 0, maxv+1);
...
bool testDistanceTransformationBorder()
{
  ...
  Board2D board;
  board.setUnit ( LibBoard::Board::UCentimeter );
  drawImage<Hue>(board, image, (unsigned int)0, (unsigned int)150); //image.selfDraw<Hue> ( board, 0, 150 );
...
bool testChessboard()
{
  ...
  board.clear();
  drawImage<Hue>(board, result2, (DGtal::int64_t)0, (DGtal::int64_t)maxv+1); //result2.selfDraw<Hue> ( board, 0, maxv + 1);
