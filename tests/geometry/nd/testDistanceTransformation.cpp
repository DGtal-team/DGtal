...
bool testDistanceTransformation()
{
  ...
  //image.selfDraw<Gray> ( board, 0, 255 ); FAIRE
  ...
  board.clear();
  //result.selfDraw<Gray> ( board, 0, 16 ); FAIRE
...
bool testDistanceTransformationNeg()
{
  ...
  Board2D board;
  board.setUnit ( LibBoard::Board::UCentimeter );
  //image.selfDraw<Gray> ( board, 0, 1 ); FAIRE
  ...
  board.clear();
  //result.selfDraw<Gray> ( board, 0, maxv ); FAIRE
...
bool testDTFromSet()
{
  ...
  //result.selfDraw<Hue> ( board, 0, maxv+1); FAIRE
  ...
  for ( ImageLong::Iterator it = result0.begin(), itend = result0.end();
    ...
    if ( (*it) > maxv)
      maxv = (*it);
  trace.error() << "MaxV="<<maxv<<std::endl;
  //result0.selfDraw<Hue> ( board, 0, maxv+1); FAIRE
  ...
  for ( ImageLong::Iterator it = result1.begin(), itend = result1.end();
    ...
    if ( (*it) > maxv)
      maxv = (*it);
  trace.error() << "MaxV="<<maxv<<std::endl;
  //result1.selfDraw<Hue> ( board, 0, maxv+1); FAIRE
...
bool testDistanceTransformationBorder()
{
  ...
  Board2D board;
  board.setUnit ( LibBoard::Board::UCentimeter );
  //image.selfDraw<Hue> ( board, 0, 150 ); FAIRE
...
bool testChessboard()
{
  ...
  board.clear();
  //result2.selfDraw<Hue> ( board, 0, maxv + 1); FAIRE
