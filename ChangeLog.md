...
- *Build*
  ...
  - Fix the compilation by using boost::first_max_element instead std::max_element due
    to the the ConstIteratorAdapter that does not satisfy the _is_forward concept of the STL
    (on apple clang compiler). 
