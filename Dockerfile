...
RUN cd /home/digital/git/DGtal/build &&  cmake .. -DDGTAL_WITH_GMP=true -DDGTAL_WITH_FFTW3=true - DDGTAL_WITH_CGAL=true  -DDGTAL_WITH_ITK=true -DDGTAL_WITH_OPENMP=true  -DDGTAL_WITH_CAIRO=true -DWITH_QGLVIEWER=true -DWITH_MAGICK=true && make install
