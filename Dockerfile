...
RUN cd /home/digital/git/DGtal/build &&  cmake .. -DWITH_EIGEN=true -DDGTAL_WITH_FFTW3=true - DDGTAL_WITH_CGAL=true  -DDGTAL_WITH_ITK=true -DDGTAL_WITH_OPENMP=true  -DDGTAL_WITH_CAIRO=true -DDGTAL_WITH_POLYSCOPE_VIEWER=true -DWITH_MAGICK=true && make install
