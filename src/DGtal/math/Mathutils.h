 ...
 * @date 2010/07/01
 *
 * Header file for module Mathutils.cpp (backport from imagene)
 *
...
namespace DGtal
{
  ...
  public:
    ...
    struct ModuloComputer 
    {
       ...
       * @see k
       */
      void increment( unsigned int & i ) const;
       ...
       * @see k
       */
      void decrement( unsigned int & i ) const;
       ...
       * @see k
       */
      unsigned int previous( unsigned int i ) const;
       ...
       * @see k
       */
      bool less( unsigned int i, unsigned int j ) const;
       ...
       * @see k
       */
      unsigned int posDiff( unsigned int j, unsigned int i ) const;
  ...
  private:
     ...
     * Forbidden by default.
     */
    Mathutils & operator=( const Mathutils & other );
