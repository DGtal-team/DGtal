 ...
 * @date 2012/11/23
 *
 * Header file for module OldAlias.cpp
 *
 * This file is part of the DGtal library.
 */

#if defined(OldAlias_RECURSES)
#error Recursive header files inclusion detected in OldAlias.h
#else // defined(OldAlias_RECURSES)
/** Prevents recursive inclusion of headers. */
#define OldAlias_RECURSES

#if !defined OldAlias_h
...
#include "DGtal/base/OldAlias.ih"

//                                                                           //
///////////////////////////////////////////////////////////////////////////////

#endif // !defined OldAlias_h

#undef OldAlias_RECURSES
#endif // else defined(OldAlias_RECURSES)
