...
namespace DGtal
{
  ...
  { 
    ...
    struct _IsCirculator 
    {
      static const bool value; 
    };
    template <typename IC, bool flagHasNestedTypeType> 
    const bool _IsCirculator<IC, flagHasNestedTypeType>::value = false; 


    template <typename IC> 
    struct _IsCirculator<IC,true> 
    {
    ...
    template <typename IC> 
    const bool _IsCirculator<IC, true>::value = ( sizeof(test(typename IC::Type())) == sizeof(yes) ); 
  } //namespace detail
  ...
  template <typename IC> 
  const bool IsCirculator<IC>::value = detail::_IsCirculator<IC, detail::HasNestedTypeType<IC>::value >::value; 
