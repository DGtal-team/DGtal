...
namespace DGtal
{
   ...
   */
  template <typename TArgumentInteger, concepts::CEuclideanRing TResultInteger = TArgumentInteger>
  ...
  public:
    ...
    // 1BOOST_CONCEPT_ASSERT(( concepts::CEuclideanRing<ArgumentInteger> )); 
