...
namespace DGtal {
  ...
  template<typename TPoint>
    ImplicitBall<SpaceND<TPoint::dimension> > ballFrom2Points(TPoint & aPoint, TPoint & otherPoint) {
      typename SpaceND<TPoint::dimension>::RealPoint center((aPoint + otherPoint)/2);
   ...
   */
  template<typename TPoint>
  ImplicitBall<SpaceND<TPoint::dimension> > ballFrom3Points(const TPoint & p1, const TPoint & p2,const TPoint & p3) {
...
getBallFrom4Point3D(TPoint & A, TPoint & B, TPoint & C, TPoint & D) {
