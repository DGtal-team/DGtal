 ...
 * @date 2012/03/27
 *
 * Header file for module DigitalSurfaceConvolver.cpp
 *
 ...
 * @tparam TSupportConstIterator a model of const iterator on signed cells 
 * @tparam TKernelFunctor a functor on signed cells
 */
