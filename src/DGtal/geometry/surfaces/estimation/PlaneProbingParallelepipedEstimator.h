...
namespace DGtal
{
  ...
  public:
    ...
    /**
     * Returns the point 'p' that is the base point of the parallelepiped.
     */
    Point getOrigin () const;

    /**
     * Get the current state of the parallelepiped i.e. the number of points of the parallelepiped inside the plane.
     */
    int getState () const;

    /**
     * Returns whether the current parallelepiped is separating or not (q and getOrigin are inside/outside or outside/inside the plane).
     */
    ...
    /**
     * Returns whether we are in a reversd state or not.
     */
