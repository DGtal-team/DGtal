...
namespace DGtal
{
  ...
  public: 
     ...
     * Constructor.
     */
    L2FirstOrderIncrementalMetricHelper(const DGtal::PointVector<dimension, double>& aGridStepsVector);
  ...
  public:
     ...
     * Constructor.
     */
    LInfinityFirstOrderIncrementalMetricHelper(const DGtal::PointVector<dimension, Value>& aGridStepsVector);
