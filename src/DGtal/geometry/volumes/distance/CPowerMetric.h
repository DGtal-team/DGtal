...
public:
  ...
  void checkConstConstraints() const
  {
    ...
    ConceptUtils::sameType( aclosest, myX.closestWeighted( myPoint , myPoint2, myW2,myPoint3, myW3 ) );
  }
  // ------------------------- Private Datas --------------------------------
private:
