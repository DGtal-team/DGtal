...
namespace DGtal
{
  ...
  public:
    ...
    /// @param[out] pts the range of lattice points that are interior to this polytope i.e. striclty inside).
    /// @param[in] a any axis with 0 <= a < d, where d is the dimension of the space.
    ///
    /// @note The result does not depend on parameter \a a, but the
    /// speed of computation depends on this choice. The best choice
    /// is the one that minimizes the projected area of the polytope
