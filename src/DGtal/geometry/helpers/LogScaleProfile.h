 ...
 * @date 2015/11/08
 *
 * Header file for module LogScaleProfile.cpp
 *
 * This file is part of the DGtal library.
 */

#if defined(LogScaleProfile_RECURSES)
#error Recursive header files inclusion detected in LogScaleProfile.h
#else // defined(LogScaleProfile_RECURSES)
/** Prevents recursive inclusion of headers. */
#define LogScaleProfile_RECURSES

#if !defined LogScaleProfile_h
/** Prevents repeated inclusion of headers. */
#define LogScaleProfile_h
...
namespace DGtal
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  // class LogScaleProfile
  /**
   * Description of class 'LogScaleProfile' <p> \brief Aim: This class
   ...
   * done in logspace.
   *
   * For instance, to use a LogScaleProfile on 10 scale levels (from 1 to
   * 10) you can start to construct and initialize a LogScaleProfile as
   * follows:
   *
   * @code 
   * LogScaleProfile sp;
  ...
  public:
     ...
     * 
     **/
    enum LogScaleProfileType{MEAN, MAX, MIN, MEDIAN};
     ...
     */
    LogScaleProfile(LogScaleProfileType type);
     ...
     */
    LogScaleProfile( const LogScaleProfile & other );
     ...
     */
    LogScaleProfile & operator= ( const LogScaleProfile & other );
  ...
  public:
     ...
     **/    
    void setType(LogScaleProfileType type);
  ...
  private:
    ...
    LogScaleProfileType myProfileDef;
  ...
  }; // end of class LogScaleProfile


  /**
   * Overloads 'operator<<' for displaying objects of class 'LogScaleProfile'.
   * @param out the output stream where the object is written.
   * @param object the object of class 'LogScaleProfile' to write.
   * @return the output stream after the writing.
   */
  std::ostream&
  operator<< ( std::ostream & out, const LogScaleProfile & object );
...
#include "DGtal/geometry/helpers/LogScaleProfile.ih"
#endif
...
#endif // !defined LogScaleProfile_h

#undef LogScaleProfile_RECURSES
#endif // else defined(LogScaleProfile_RECURSES)
