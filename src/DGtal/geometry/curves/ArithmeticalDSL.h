...
namespace DGtal
{
  namespace detail {
    ...
    requires concepts::CSignedNumber<TInput> && 
             concepts::CInteger<TInput> &&
             concepts::CSignedNumber<TOutput> && 
             concepts::CInteger<TOutput>
    ...
    requires concepts::CSignedNumber<TOutput> && 
             concepts::CInteger<TOutput>
