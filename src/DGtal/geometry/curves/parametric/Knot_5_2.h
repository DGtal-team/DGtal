 ...
 * @date 2014/10/01
 *
 * Header file for module Knot_5_2
 *
 * This file is part of the DGtal library.
 */

#if defined(Knot_5_2_RECURSES)
#error Recursive header files inclusion detected in Knot_5_2.h
#else // defined(Knot_5_2_RECURSES)
/** Prevents recursive inclusion of headers. */
#define Knot_5_2_RECURSES

#if !defined Knot_5_2_h
...
// class Knot_5_2
/**
 * Description of class 'Knot_5_2' <p>
 * \brief Aim: Implement a parametrized knot 5, 2.
...
template <typename T>
std::ostream&
operator<< ( std::ostream & out, const Knot_5_2<T> & object );
...
#include "DGtal/geometry/curves/parametric/Knot_5_2.ih"
#endif
...
#endif // !defined Knot_5_2_h

#undef Knot_5_2_RECURSES
#endif // else defined(Knot_5_2_RECURSES)
