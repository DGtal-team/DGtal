 ...
 * @date 2014/10/01
 *
 * Header file for module Knot_6_2.cpp
 *
 * This file is part of the DGtal library.
 */

#if defined(Knot_6_2_RECURSES)
#error Recursive header files inclusion detected in Knot_6_2.h
#else // defined(Knot_6_2_RECURSES)
/** Prevents recursive inclusion of headers. */
#define Knot_6_2_RECURSES

#if !defined Knot_6_2_h
...
// class Knot_6_2
/**
 * Description of class 'Knot_6_2' <p>
 * \brief Aim: Implement a parametrized knot 6, 2.
...
template <typename T>
std::ostream&
operator<< ( std::ostream & out, const Knot_6_2<T> & object );
...
#include "DGtal/geometry/curves/parametric/Knot_6_2.ih"
#endif
...
#endif // !defined Knot_6_2_h

#undef Knot_6_2_RECURSES
#endif // else defined(Knot_6_2_RECURSES)
