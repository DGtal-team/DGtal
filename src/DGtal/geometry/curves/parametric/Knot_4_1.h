 ...
 * @date 2014/10/01
 *
 * Header file for module Knot_4_1.cpp
 *
 * This file is part of the DGtal library.
 */

#if defined(Knot_4_1_RECURSES)
#error Recursive header files inclusion detected in Knot_4_1.h
#else // defined(Knot_4_1_RECURSES)
/** Prevents recursive inclusion of headers. */
#define Knot_4_1_RECURSES

#if !defined Knot_4_1_h
...
// class Knot_4_1
/**
 * Description of class 'Knot_4_1' <p>
 * \brief Aim: Implement a parametrized knot 4, 1.
...
template <typename T>
std::ostream&
operator<< ( std::ostream & out, const Knot_4_1<T> & object );
...
#include "DGtal/geometry/curves/parametric/Knot_4_1.ih"
#endif
...
#endif // !defined Knot_4_1_h

#undef Knot_4_1_RECURSES
#endif // else defined(Knot_4_1_RECURSES)
