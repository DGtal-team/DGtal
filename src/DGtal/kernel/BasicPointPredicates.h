...
namespace DGtal
{
  ...
  struct NotPointPredicate
  {
    ...
    BOOST_STATIC_ASSERT (( CPointPredicate<PointPredicate> )); 
  ...
  struct BinaryPointPredicate
  {
    ...
    BOOST_STATIC_ASSERT (( CPointPredicate<PointPredicate1> )); 
    BOOST_STATIC_ASSERT (( CPointPredicate<PointPredicate2> )); 
