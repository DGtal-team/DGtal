...
namespace DGtal
{
  namespace experimental
  {
    ...
    public:
      ...
      // static constants
      static const typename TDomain::Space::DimensionType dim = TDomain::staticDimension;
      static const typename TDomain::Space::DimensionType staticDimension = TDomain::staticDimension;
