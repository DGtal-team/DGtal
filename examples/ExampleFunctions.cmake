...
function(DGtal_add_example test_file)
  ...
  if (${_random} LESS ${DGTAL_RANDOMIZED_TESTING_THRESHOLD}  OR ${test_file} IN_LIST DGTAL_RANDOMIZED_TESTING_WHITELIST)
    ...
    if (${ARGC} GREATER 1) #For external libs
      target_link_libraries(${test_file} PRIVATE DGtal ${DGTAL_LIBRARIES} ${ARGVN})
    else()
      target_link_libraries(${test_file} PRIVATE DGtal ${DGTAL_LIBRARIES})
    endif()
