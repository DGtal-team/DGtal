...
int main()
{
  ...
  set.insertNew(Point(1,1));	
  set.insertNew(Point(1,2));
  set.insertNew(Point(1,3));
  set.insertNew(Point(1,4));
  set.insertNew(Point(1,5));
  set.insertNew(Point(1,6));
  set.insertNew(Point(1,7));
