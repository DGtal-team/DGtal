...
int main()
{
  ...
  aBoard.clear();
  drawImage<Gray>(aBoard, image, (unsigned char)0, (unsigned char)255); //image.selfDraw<Gray> ( aBoard, 0, 255 );
  ...
  aBoard.clear();
  drawImage<HueTwice>(aBoard, result, (OutputImage::Value)0, (OutputImage::Value)maxDT); //result.selfDraw<HueTwice> ( aBoard, 0, maxDT );
