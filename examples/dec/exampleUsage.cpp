...
void demo2d()
{
    ...
    // primal path
    {
        ...
        for (Calculus::PrimalForm0::Index index=0; index<primal_zero_form.container.rows(); index++)
        {
    ...
    // dual path
    {
        ...
        for (Calculus::DualForm0::Index index=0; index<dual_zero_form.container.rows(); index++)
        {
