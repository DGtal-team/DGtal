...
/*
  ...
  plot [1e2:1e7][1e-2:1e4] "./timings-p-convexity-Z2.txt" using 1:($3 == 1 ? $2 : 1/0) title "P-convex in Z2" w p, "./timings-p-convexity-Z2.txt" using 1:($3 == 0 ? $2 : 1/0) title "non P-convex in Z2" w p, "./timings-fc-convexity-Z2.txt" using 1:($3 == 1 ? $2 : 1/0) title "fully convex in Z2" w p, "./timings-fc-convexity-Z2.txt" using 1:($3 == 0 ? $2 : 1/0) title "non fully convex in Z2" w p, "./timings-fcf-convexity-Z2.txt" using 1:($3 == 1 ? $2 : 1/0) title "fully convex in Z2 (fast)" w p pt 6, "./timings-fcf-convexity-Z2.txt" using 1:($3 == 0 ? $2 : 1/0) title "non fully convex in Z2 (fast)" w p pt 7, 0.2e-5*x*log(x) w l lw 2

  plot [1e2:1e7][1e-2:1e4] "./timings-p-convexity-Z3.txt" using 1:($3 == 1 ? $2 : 1/0) title "P-convex in Z3" w p, "./timings-p-convexity-Z3.txt" using 1:($3 == 0 ? $2 : 1/0) title "non P-convex in Z3" w p, "./timings-fc-convexity-Z3.txt" using 1:($3 == 1 ? $2 : 1/0) title "fully convex in Z3" w p, "./timings-fc-convexity-Z3.txt" using 1:($3 == 0 ? $2 : 1/0) title "non fully convex in Z3" w p, "./timings-fcf-convexity-Z3.txt" using 1:($3 == 1 ? $2 : 1/0) title "fully convex in Z3 (fast)" w p pt 6, "./timings-fcf-convexity-Z3.txt" using 1:($3 == 0 ? $2 : 1/0) title "non fully convex in Z3 (fast)" w p pt 7, 0.2e-5*x*log(x) w l lw 2

  plot [1e2:1e7][1e-2:1e4] "./timings-p-convexity-Z4.txt" using 1:($3 == 1 ? $2 : 1/0) title "P-convex in Z4" w p, "./timings-p-convexity-Z4.txt" using 1:($3 == 0 ? $2 : 1/0) title "non P-convex in Z4" w p, "./timings-fc-convexity-Z4.txt" using 1:($3 == 1 ? $2 : 1/0) title "fully convex in Z4" w p, "./timings-fc-convexity-Z4.txt" using 1:($3 == 0 ? $2 : 1/0) title "non fully convex in Z4" w p, "./timings-fcf-convexity-Z4.txt" using 1:($3 == 1 ? $2 : 1/0) title "fully convex in Z4 (fast)" w p pt 6, "./timings-fcf-convexity-Z4.txt" using 1:($3 == 0 ? $2 : 1/0) title "non fully convex in Z4 (fast)" w p pt 7, 0.2e-5*x*log(x) w l lw 2
