...
/**
 * @file geometry/volumes/exampleBoundedLatticePolytopeCount4D.cpp
 * @ingroup Examples
...
\example geometry/volumes/exampleBoundedLatticePolytopeCount4D.cpp
*/
...
int main( int argc, char* argv[] )
{
  ...
  typedef DGtal::ConvexityHelper< 4, Integer > Helper;
