...
cmake_dependent_option(WITH_QGLVIEWER_QT5 "With LibQGLViewer for 3D visualisation (Qt5 required)" OFF
                       "NOT WITH_QGLVIEWER" OFF)
...
message(STATUS "      WITH_QGLVIEWER          true    (Qt4/QGLViewer based 3D Viewer)")
ELSE(WITH_QGLVIEWER)
message(STATUS "      WITH_QGLVIEWER          false   (Qt4/QGLViewer based 3D Viewer)")
ENDIF(WITH_QGLVIEWER)

if (WITH_QGLVIEWER_QT5)
  set(LIST_OPTION ${LIST_OPTION} [QGLVIEWER]\ )
  message(STATUS "      WITH_QGLVIEWER_QT5      true    (Qt5/QGLViewer based 3D Viewer)")
else (WITH_QGLVIEWER_QT5)
  message(STATUS "      WITH_QGLVIEWER_QT5      false   (Qt5/QGLViewer based 3D Viewer)")
endif (WITH_QGLVIEWER_QT5)
...
set( WITH_VISU3D 0)
IF(WITH_QGLVIEWER OR WITH_QGLVIEWER_QT5)
...
ENDIF(WITH_QGLVIEWER OR WITH_QGLVIEWER_QT5)
