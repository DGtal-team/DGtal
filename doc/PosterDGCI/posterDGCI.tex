...
\center \rput(0cm,-2cm){\includegraphics[width=14cm]{Logos/logoDGCI2.eps}} \\
\vspace{6cm}
...
\begin{tabular}{ccc}
  ...
  \multirow{2}{*}{
    \framebox{%
      \includegraphics[height=0.27\textwidth]{Images/code-thinning.eps}%
    }
  }&
  \raisebox{-4cm}{
    \framebox{%
...
%  \includegraphics[height=0.2\textwidth]{Images/contourS1-2.eps}%
  \includegraphics[trim= 1cm 1.5cm 1cm 0.5cm, clip, height=0.2\textwidth]{Images/contourS1-2.eps}%
}&
\framebox{%
